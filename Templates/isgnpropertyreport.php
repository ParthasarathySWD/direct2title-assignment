                ...
                <table cellspacing="0" style="width: 100%;margin-top: 8pt;border: 0.01em solid grey;">
                    <tr>
                        <td class="td-bd text-center">
                            <p style="font-size: 7pt;" class="bold text-center" colspan="1">Title Held by</p>
                        </td>
                        <td class="td-bd" colspan="7">
                            <p style="font-size: 7pt;">%%Grantee%% <span style="color:#ff0000; ">%%MaritalStatusName%%</span></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-bd text-center">
                            <p style="font-size: 7pt;" class="bold" colspan="1">Estate Type</p>
                        </td>
                        <td class="td-bd text-center" colspan="2">
                            <p style="font-size: 7pt;" class="text-center">%%EstateInterestName%%</p>
                        </td>
                        <td class="td-bd text-center" colspan="2">
                            <p style="font-size: 7pt;padding:0pt 8pt;" class="bold text-center">Tenancy</p>
                        </td>
                        <td class="td-bd text-center" colspan="2">
