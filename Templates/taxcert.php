...
<div class="wrapper">
    ...
    <div style="padding-top: 10pt;">
        ...
        <div style="padding-top: 10pt;">
            <table style="width: 100%;" cellspacing="0">
                <tr>
                    <td class="td-bd text-center bold" style="width: 14.11%;;" rowspan="2">Borrower</td>
                    <td class="td-bd text-center" style="width:27.6%;;" rowspan="2">%%Borrowers%%</td>
                ...
                <tbody>
                    <tr style="">
                        <td width="14.7%" class="td-bd text-center" style="">
                            <p style="font-size: 7pt;" class="bold">Taxing Entity</p>
                        </td>
                        ...
                        <td width="14.7%" class="td-bd text-center" style="">
                            <p style="font-size: 7pt;" class="bold">&nbsp;Parcel ID&nbsp;</p>
                        </td>
                        <td width="43.5%" class="td-bd text-center" style="">
                            <p style="font-size: 7pt;" class="text-center">%%ParcelNumber%%</p>
                        </td>
                    </tr>
                    <tr style="">
                        <td width="14.7%" class="td-bd text-center">
                            <p style="font-size: 7pt;" class="bold">Tax Installment</p>
                        </td>
                        <td width="27.6%" class="td-bd text-center">
                            <p style="font-size: 7pt;" class="text-center">%%TaxBasisName%%</p>
                        </td>
                        <td width="14.7%" class="td-bd text-center">
                            <p style="font-size: 7pt;" class="bold">Property Type</p>
                        </td>
                        <td width="43.5%" class="td-bd text-center">
                            <p style="font-size: 7pt;" class="text-center">%%PropertyClassName%%</p>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table style="width: 100%;border: 0.01em solid grey;" cellspacing="0">
                <tr style="">
                    ...
                    <td width="18.6%" class="td-bd text-center">
                        <p style="font-size: 7pt;" class="text-center bold">Tax Installments</p>
                    </td>
                    <td width="13.5%" class="td-bd text-center">
                        <p style="font-size: 7pt;" class="bold">Base Amount</p>
                    </td>
                    <td width="14.7%" class="td-bd text-center">
                        <p style="font-size: 7pt;" class="text-center bold">Tax Status</p>
                    </td>
                    <td width="21.8%" class="td-bd text-center">
                        <p style="font-size: 7pt;" class="bold">Paid Amount</p>
                    </td>
                    <td width="21.8%" class="td-bd text-center">
                        <p style="font-size: 7pt;" class="bold">Due/Paid Date</p>
                    </td>
                    <!-- <td class="td-bd text-center" colspan="3" style=""> <p style="font-size: 7pt;" class=" text-center bold">Good Through Date</p></td>-->
                    ...
                    <tbody>
                        ...
                        <tr style="border: 0.01em solid grey;">
                            ...
                            <td class="td-bd text-center" colspan="7" style="">
                                <p style="font-size: 7pt;color:#0066ff" class="text-center"><u>%%WebsiteAddress%%</u></p>
                            </td>
                        </tr>
                    </tbody>
                </table>
