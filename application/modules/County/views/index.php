                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 col-lg-6 pl-0">
                                    <h3 class="card-title pt-2">Counties</h3>
                                </div>
                                <div class="col-md-6 col-lg-6 text-right pr-0 pt-2">

                                  <!-- Split dropup button -->
                                  <div class="btn-group dropdown">
                                    <a href="County/add" type="button" class="btn btn-success pl-3 pr-3" style="position: relative;right: -4px;border-top-left-radius: 20px;border-bottom-left-radius: 20px;">
                                        <i class="fe fe-plus"></i>  Add County
                                    </a>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="County/add" class="dropdown-item"><i class="dropdown-icon fa fa-plus"></i> New County </a>
