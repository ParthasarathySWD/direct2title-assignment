<link href="assets/lib/chrome_tab/chrome-tabs.css" rel="stylesheet">
<link href="assets/css/module/myloan/myloan.css" rel="stylesheet">
<!-- start body header -->
            ...
            <div class="col-md-12 col-lg-12">
              <div class="mock-browser">
                <div class="chrome-tabs" style="--tab-content-margin: 9px">
                  <div class="chrome-tabs-content nav">
                    <a data-toggle="tab" href="#tab001" class="chrome-tab" active>
                    ...
                    <div class="chrome-tab-content">
                        <div class="chrome-tab-title">MY LOANS</div>
                        <div class="chrome-tab-drag-handle"></div>
                        <div class="chrome-tab-close"></div>
                    </div>
                </a>

                <a data-toggle="tab" href="#tab002" class="chrome-tab">
                  <div class="chrome-tab-dividers"></div>
                  <div class="chrome-tab-background">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><symbol id="chrome-tab-geometry-left" viewBox="0 0 214 36"><path d="M17 0h197v36H0v-2c4.5 0 9-3.5 9-8V8c0-4.5 3.5-8 8-8z"/></symbol><symbol id="chrome-tab-geometry-right" viewBox="0 0 214 36"><use xlink:href="#chrome-tab-geometry-left"/></symbol><clipPath id="crop"><rect class="mask" width="100%" height="100%" x="0"/></clipPath></defs><svg width="52%" height="100%"><use xlink:href="#chrome-tab-geometry-left" width="214" height="36" class="chrome-tab-geometry"/></svg><g transform="scale(-1, 1)"><svg width="52%" height="100%" x="-100%" y="0"><use xlink:href="#chrome-tab-geometry-right" width="214" height="36" class="chrome-tab-geometry"/></svg></g></svg>
                </div>
                <div class="chrome-tab-content">
                    <div class="chrome-tab-title">F19088675</div>
                    <div class="chrome-tab-drag-handle"></div>
                    <div class="chrome-tab-close"></div>
                </div>
            </a>

            <a data-toggle="tab" href="#tab003" class="chrome-tab">
              <div class="chrome-tab-dividers"></div>
              <div class="chrome-tab-background">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><symbol id="chrome-tab-geometry-left" viewBox="0 0 214 36"><path d="M17 0h197v36H0v-2c4.5 0 9-3.5 9-8V8c0-4.5 3.5-8 8-8z"/></symbol><symbol id="chrome-tab-geometry-right" viewBox="0 0 214 36"><use xlink:href="#chrome-tab-geometry-left"/></symbol><clipPath id="crop"><rect class="mask" width="100%" height="100%" x="0"/></clipPath></defs><svg width="52%" height="100%"><use xlink:href="#chrome-tab-geometry-left" width="214" height="36" class="chrome-tab-geometry"/></svg><g transform="scale(-1, 1)"><svg width="52%" height="100%" x="-100%" y="0"><use xlink:href="#chrome-tab-geometry-right" width="214" height="36" class="chrome-tab-geometry"/></svg></g></svg>
            </div>
            <div class="chrome-tab-content">
                <div class="chrome-tab-title">F19088676</div>
                <div class="chrome-tab-drag-handle"></div>
                <div class="chrome-tab-close"></div>
            </div>
        </a>

        <i class="fe fe-more-horizontal" style="    right: 0px;
        top: -3px;
        font-size: 25px;
        cursor: pointer;
        position: absolute;display:none;"></i>
    </div>
...
<div class="tab-content" style="display:none">
    <div class="tab-pane fade " id="tab001">1
    </div>
    <div class="tab-pane fade active show" id="tab002">2
    </div>
    <div class="tab-pane fade" id="tab003">3
    </div>
</div>
</div>
</div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 col-lg-6 pl-0">
                        <h3 class="card-title pt-2">Loans</h3>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="new-custom-main-tab-head">
                        <li style="width:50%;">New</li>
                        <li style="width:50%;">Completed</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <ul class="new-custom-main-tab nav-tabs nav" style="border:0;">
                        <li style="width:25%;"><a data-toggle="tab" href="#all-1"><span class="count"><i class="icon-doc"></i> 100</span>New Loans</a></li>
                        <li style="width:25%;"><a data-toggle="tab" href="#all-2"><span class="count"><i class="icon-doc"></i> 100</span>New Loans</a></li>
                        <li style="width:25%;"><a data-toggle="tab" href="#all-3"><span class="count"><i class="icon-close"></i> 100</span>Printing Loans</a></li>
                        <li style="width:25%;"><a data-toggle="tab" href="#all-4"><span class="count"><i class="fe fe-check-circle"></i> 100</span>Review Loans</a></li>
                    </ul>
                </div>
            </div>
            <div class="tab-content" style="display:none;">
            ...
            <table class="table table-vcenter text-nowrap resizable new-datatable1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div>LN29383620</div>
                            <div class="small text-muted">Imported on: Mar 4, 2018</div>
                        </td>
                        <td>
                            Goldsman Sach Bank
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <div class="item-action dropdown ml-2">
                                <a href="javascript:void(0)" data-toggle="dropdown" style="font-weight: bold; color: #464bac; ">View Loan<i class="fe fe-more-vertical" style="vertical-align: middle; font-size: 20px !important;"></i></a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="progress progress-xs">
                                <div class="progress-bar bg-green" role="progressbar" style="width: 100%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </td>
                        <td>
                            <div class="small text-muted">Last login</div>
...
<script src="assets/lib/chrome_tab/chrome-tabs.js"></script>
<script>
