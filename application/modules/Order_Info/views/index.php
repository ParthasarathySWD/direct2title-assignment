                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="col-md-12 ex3">
                          ...
                          <input class="CopyText" id="CopyText" name="CopyText" type="text"  value="Test" style="height: 0px;width: 1px;border: 0px;" >
                          <input class="CPY" id="CPY" name="CPY" type="text" value="" style="border:none;color:#fff;font-size: 1px;">
                    ...
                    <div class="col-md-12 col-lg-12 mb-3 mt-0 p-0">
                      ...
                      <div class="btn-list text-right">
                        ...
                        <?php if($checkreviewassigned_user == 1 && $checkreviewholdstatus == 1){ ?>
                          <button class="btn btn-success Reviewunholdorder hide-btn" id="unholdorder" name="<?php echo $OrderrUID;?>" style=" "><i class="fa fa-ban" style="color: #fff;"></i> &nbsp; Review Release OnHold</button>
                        <?php } ?>
                        ...
                        <?php if($checkholdstatus == 0 ){ ?>
                          <button class="btn btn-danger auto_save_info md-trigger typing_complete" ><i class="fa fa-save" style="color: #fff;margin-top: 12px;"></i> &nbsp; Typing Complete</button>
...
<script type="text/javascript">
  ...
  $('body').on('click','.choose', function(event) { 
    ...
    $('#CPY').val(selectedfieldkeyword);

    var cTxt = document.getElementById("CPY");
