                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 col-lg-6 pl-0">
                                    <h3 class="card-title pt-2">States</h3>
                                </div>
                                <div class="col-md-6 col-lg-6 text-right pr-0 pt-2">

                                  <!-- Split dropup button -->
                                  <div class="btn-group dropdown">
                                    <a href="State/add" type="button" class="btn btn-success pl-3 pr-3" style="position: relative;right: -4px;border-top-left-radius: 20px;border-bottom-left-radius: 20px;">
                                        <i class="fe fe-plus"></i>  Add State
                                    </a>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="State/add" class="dropdown-item"><i class="dropdown-icon fa fa-plus"></i> New State </a>
                                        <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-upload"></i> Import State </a>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <ul class="new-custom-main-tab nav-tabs nav" style="border:0;">
                                <li style="width:50%;"><a data-toggle="tab" href="#all-1"><span class="count"><i class="icon-doc"></i> 100</span>Total States</a></li>
                                <li style="width:25%;"><a data-toggle="tab" href="#all-3"><span class="count"><i class="fe fe-check-circle"></i> 100</span>Active States</a></li>
                                <li style="width:25%;"><a data-toggle="tab" href="#all-4"><span class="count"><i class="icon-close"></i> 100</span>In Active States</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3 pl-4">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fa fa-eye"></i> View States </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
