                            ...
                            <div class="col-md-12 col-lg-12 mb-3 mt-2">
                                <div class="btn-list  text-right">
                                   <!--  <a href="#" class="btn btn-outline-secondary">Cancel</a>
                                    ...
                                    <button type="button" data-moveon="clientpricing" class="btn btn-outline-secondary wizard-btn btn-space"><i class="fa fa-angle-double-left"></i> Previous</button>
                                    <button data-moveon="clientworkflows" class="btn btn-primary wizard-btn wizard-next">Next <i class="fa fa-angle-double-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
