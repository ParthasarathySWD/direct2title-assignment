...
class GoogleStaticMap {
	...
	public $sGoogleURL = 'maps.google.com/maps/api/staticmap';
	public $aLanguages = array('eu', 'bg', 'bn', 'ca', 'cs', 'da', 'de', 'el', 'en', 'en-AU', 'en-GB', 'es', 'eu', 'fa', 'fi', 'fil', 'fr', 'gl', 'gu', 'hi', 'hr', 'hu', 'id', 'it', 'iw', 'ja', 'kn', 'ko', 'lt', 'lv', 'ml', 'mr', 'nl', 'nn', 'no', 'or', 'pl', 'pt', 'pt-BR', 'pt-PT', 'rm', 'ro', 'ru', 'sk', 'sl', 'sr', 'sv', 'tl', 'ta', 'te', 'th', 'tr', 'uk', 'vi', 'zh-CN', 'zh-TW');
	public $aFormatTypes = array('png', 'png8', 'png32', 'gif', 'jpg', 'jpg-baseline');
	public $aMapTypes = array('roadmap', 'satellite', 'hybrid', 'terrain');
	public $aScales = array(1, 2, 4); //4 is business only
	public $bHTTPS = TRUE;
	public $sAPIKey = 'AIzaSyC04ReLSydrSUPZRsh_6VaX4Moav-Wk7rs';  //TODO Finishing Adding
	public $mCenter = null;  //{latitude,longitude} or ('city hall, new york, ny')
	public $iZoom = 10;
	public $iHeight = 200;
	public $iWidth = 200;
	public $iScale = 1;
	public $sFileFormat = 'png';
	public $sMapType = 'roadmap'; //See $map_types;
	public $sLanguage = 'en-GB';
	public $sRegion = '';   //TODO Add
	public $aMarkers = array();
	public $oPath = array();   //TODO Add
	public $aVisible = array();  //TODO Add
	public $aFeatureStyling = array();
	public $bSensor = true;
