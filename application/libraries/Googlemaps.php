...
class Googlemaps {
		...
		var $apiKey						= 'AIzaSyC04ReLSydrSUPZRsh_6VaX4Moav-Wk7rs'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
		...
		function get_lat_long_from_address($address, $attempts = 0)
		{
			...
			$data_location .= "maps.googleapis.com/maps/api/geocode/json?address=".urlencode(utf8_encode($address))."&sensor=".$this->sensor.'&key='.$this->apiKey;
