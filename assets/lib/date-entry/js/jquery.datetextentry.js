    ...
    var DateTextInput = function (options) {
        ...
        this.$input = $('<input type="text" value="" />')
            ...
            .change(function (e) {
                ...
                var date = $(this).closest('span').find('.jq-dte-day').val();
                var month = $(this).closest('span').find('.jq-dte-month').val();
                var year = $(this).closest('span').find('.jq-dte-year').val();

                if (Number(date) && Number(month) && Number(year)) {
                    setTimeout(function () {
                        $(this).closest('span').prev('input').val(month + '/' + date + '/' +year);
            ...
            .on("paste", function(event) {
                ...
                $(this).closest('span').prev('input').val(dateformat.Month + '/' + dateformat.Date + '/' +dateformat.Year);
                $('#SigningDate').trigger('change');
                $('#signingDate').trigger('change');
