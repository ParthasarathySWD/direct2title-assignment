...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'https://www.ordersportal.isgnsolutions.com/uploads/SampleTemplate/img/'; // Relative to domain name
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]

	$config['upload_path'] = '/var/www/html/direct2title.live/uploads/SampleTemplate/img';
