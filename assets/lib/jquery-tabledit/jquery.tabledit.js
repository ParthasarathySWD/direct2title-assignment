         ...
         */
         var Draw = {
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton || settings.addButton) {
                        var editButton = '';
                        var addButton = '';
                        var deleteButton = '';
                        var saveButton = '';
                        ...
                        if (settings.addButton && settings.saveButton) {
                            saveButton = '<button type="button" class="tabledit-save-button ' + settings.buttons.save.class + '" style="display: none; float: none;">' + settings.buttons.save.html + '</button>';
                        }
         ...
         */
         var Mode = {
            ...
            add: function(td) {
                ...
                // Add "edit" class and remove "view" class in td element.
                $(td).addClass('tabledit-add-mode').removeClass('tabledit-view-mode');
                $(td).addClass('tabledit-add-mode').removeClass('tabledit-edit-mode');
                // Update toolbar buttons.
                if (settings.addButton) {
